...
return [
    ...
    'modals' => [
        ...
        'undo_heading' => '¿Deshacer el último guardado?',
        'undo_description' => 'La configuración del servidor vuelve a como estaba antes del último "Guardar en el servidor". El servidor aún no se ha reiniciado, así que nada llegó al mundo: puedes volver sin pérdidas. Ojo: solo vuelve la configuración — tu lista de arriba sigue como la dejaste, y los archivos borrados por la papelera no vuelven.',
    ...
    'notifications' => [
        ...
        'undone' => 'Guardado deshecho',
        'undone_body' => 'La configuración del servidor volvió a como estaba: :workshop elemento(s) de la workshop y :ids ID(s) de mod. Tu lista aquí sigue igual.',
