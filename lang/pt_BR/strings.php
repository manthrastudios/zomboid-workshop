...
return [
    ...
    'actions' => [
        ...
        'undo_apply' => 'Desfazer salvamento',
    ...
    'modals' => [
        ...
        'undo_heading' => 'Desfazer o último salvamento?',
        'undo_description' => 'A configuração do servidor volta a ser o que era antes do último "Salvar no servidor". Como o servidor ainda não reiniciou, nada chegou ao mundo — dá pra voltar sem perda. Atenção: só a configuração volta — sua lista aqui em cima continua como você deixou, e arquivos apagados pelo lixinho não voltam.',
    ...
    'notifications' => [
        ...
        'undone' => 'Salvamento desfeito',
        'undone_body' => 'A configuração do servidor voltou ao estado anterior: :workshop item(ns) da workshop e :ids mod ID(s). Sua lista aqui continua como estava.',
        'undo_failed' => 'Não deu pra desfazer',
