...
return [
    ...
    'actions' => [
        ...
        'undo_apply' => 'Speichern rückgängig',
    ...
    'modals' => [
        ...
        'undo_heading' => 'Letztes Speichern rückgängig machen?',
        'undo_description' => 'Die Serverkonfiguration kehrt zu dem Stand vor dem letzten „Auf dem Server speichern" zurück. Der Server wurde noch nicht neu gestartet, es ist also nichts in der Welt angekommen — du kannst verlustfrei zurück. Hinweis: nur die Konfiguration kehrt zurück — deine Liste oben bleibt, wie du sie gelassen hast, und vom Papierkorb gelöschte Dateien kommen nicht wieder.',
    ...
    'notifications' => [
        ...
        'undone' => 'Speichern rückgängig gemacht',
        'undone_body' => 'Die Serverkonfiguration ist wieder wie zuvor: :workshop Workshop-Objekt(e) und :ids Mod-ID(s). Deine Liste hier bleibt unverändert.',
        'undo_failed' => 'Rückgängig machen nicht möglich',
