...
return [
    ...
    'modals' => [
        ...
        'undo_heading' => 'Undo the last save?',
        'undo_description' => 'The server configuration goes back to what it was before the last "Save to server". The server has not restarted yet, so nothing reached the world — you can still step back with no loss. Note that only the configuration comes back — your list above stays as you left it, and files deleted by the trash button do not return.',
    ...
    'notifications' => [
        ...
        'undone' => 'Save undone',
        'undone_body' => 'The server configuration is back to what it was: :workshop workshop item(s) and :ids mod ID(s). Your list here is unchanged.',
