...
return [
    ...
    'actions' => [
        ...
        'undo_apply' => 'Annuler l\'enregistrement',
    ...
    'modals' => [
        ...
        'undo_heading' => 'Annuler le dernier enregistrement ?',
        'undo_description' => 'La configuration du serveur revient à ce qu\'elle était avant le dernier « Enregistrer sur le serveur ». Le serveur n\'a pas encore redémarré, donc rien n\'est parvenu au monde : vous pouvez revenir en arrière sans perte. À noter : seule la configuration revient — votre liste ci-dessus reste telle quelle, et les fichiers supprimés par la corbeille ne reviennent pas.',
    ...
    'notifications' => [
        ...
        'undone' => 'Enregistrement annulé',
        'undone_body' => 'La configuration du serveur est revenue à son état précédent : :workshop élément(s) workshop et :ids ID(s) de mod. Votre liste ici reste inchangée.',
